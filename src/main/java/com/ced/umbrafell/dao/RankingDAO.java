...
public class RankingDAO {
    ...
    public List<RankingEntry> listarTop10() {
        ...
        try (Connection connection = ConnectionFactory.getConnection();
            ...
            throw new RuntimeException("Erro ao listar top 10 do ranking: " + e.getMessage(), e);
        }
    }
    ...
    public List<RankingEntry> buscarPorJogador(String nomeJogador) {
        String sql =
                "SELECT " +
                "posicao, " +
                "jogador, " +
                ...
                "resultado " +
                "FROM vw_ranking " +
                "WHERE LOWER(jogador) LIKE LOWER(?)";
        ...
        try (Connection connection = ConnectionFactory.getConnection();
            ...
            throw new RuntimeException("Erro ao buscar ranking por jogador: " + e.getMessage(), e);
        }
    }
